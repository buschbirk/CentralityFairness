...
def citation_edges(mag):
  ...
  query = """
    ...
    INNER JOIN Papers AS p1 ON paa1.PaperId = p1.PaperId
    INNER JOIN Papers AS p2 ON p2.PaperId = pr.PaperReferenceId 
